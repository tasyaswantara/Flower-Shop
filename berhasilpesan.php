...
<html>
    ...
    <nav>
        <ul>
          ...
          <li><a href="index.php">Buat Pesanan Baru</a></li>
      ...
      <section class="detail">
        ...
        WHERE pesanan.id='$_GET[id]'");
        $array_detail=mysqli_fetch_array($ambil_detail);
        $ambil_alamat= mysqli_query($koneksi,"SELECT * FROM pesanan JOIN alamat ON pesanan.id_alamat=alamat.id WHERE pesanan.id='$_GET[id]'" );
        ...
        <table  width="45%" style="margin:auto; font-size:18px; text-align:center;" border="0">
            ...
            <tbody style=" background-color:#1b1b32; color:white; ">
                ...
                WHERE item_pesanan.id_pesanan='$_GET[id]'");
                ?>
                <?php while($array_produk=mysqli_fetch_array($ambil_produk)){ ?>
                    <tr>
                        <td><?php echo $nomor++;?></td>
                        <td><?php echo $array_produk['nama_produk'];?></td>
                        <td><?php echo $array_produk['harga_produk'];?></td>
                        <td><?php echo $array_produk['jumlah'];?></td>
                        <td><?php echo $array_produk['jumlah']*$array_produk['harga_produk'];?></td>
                    </tr>
      ...
      <div class="alert">
      <p class="tanggaltotal">
        Silahkan melakukan pembayaran sebesar Rp. <?php echo number_format($array_detail['total_harga']);?><br>
        <strong>BANK BCA 031-225-71 AN. Natasya Desinta Swantara</strong>  <br>
     </p>
      </div>
